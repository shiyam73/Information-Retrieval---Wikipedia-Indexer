...
public class Runner {
	...
	private static long start,end = 0L;
	...
	private static void tokenizeAndIndex(Properties properties,
		...
		System.out.println("Completed fully in ::"+(System.currentTimeMillis() - start));
	...
	private static class ParserRunner implements Runnable {
		...
		public void run() {
			...
			System.out.println("Parser completed in ::"+ (System.currentTimeMillis() - start));
		}
